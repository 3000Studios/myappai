...
export const metadata: Metadata = {
  title: 'Web Design Trends Dominating 2025 | 3000 Studios',
  description:
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <header className="space-y-6 text-center">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto animate-fade-in-up delay-100">
            Stay ahead of the curve with the latest web design trends. Immersive 3D,
            micro-interactions, and AI-driven layouts.
          </p>
        </header>
        ...
        <div className="prose prose-invert prose-lg max-w-none glass-panel p-8 rounded-2xl animate-fade-in-up delay-200 border border-white/10">
          <p className="text-lg leading-relaxed text-gray-300">
            The web is becoming more immersive. Explore how glassmorphism, 3D elements, and
            AI-driven personalization are setting the standard for premium web experiences.
          </p>
